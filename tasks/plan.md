...
- ~~icon/logo 디자인~~ → 재확정(사용자, 2차): **CRW 브랜드 에셋 사용** —
  us/crw repo(AGPL-3.0)의 `docs/logo-icon.svg`·`docs/logo.svg`·`docs/logo.png`.
  AGPL repo 소속 에셋이라 라이선스 문제 없음(출처 표기 + 본 repo 공개). (T9)
